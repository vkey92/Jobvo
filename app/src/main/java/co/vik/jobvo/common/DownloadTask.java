...
public class DownloadTask {
    ...
    private String downloadUrl = "", downloadFileName = "",type = "";
    private ProgressDialog progressDialog;

    public DownloadTask(Context context, String downloadUrl, String type) {
            ...
            try {
                if (outputFile != null) {
                    ...
                    alertDialogBuilder.setNegativeButton("Open report",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            File pdfFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/Jobvoo/documents/" + downloadFileName);  // -> filename = maven.pdf
                            Uri path = Uri.fromFile(pdfFile);
                            Log.e("download url is = ",""+path.toString());
                            //File file = null;
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/" + "Jobvoo/documents");
                } else
